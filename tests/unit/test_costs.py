...
class TestEstimateCost:
    def test_known_model(self):
        # o1 via OpenRouter: $15/1M input, $60/1M output
        cost = estimate_cost("openrouter/openai/o1", input_tokens=1000, output_tokens=500)
    ...
    def test_zero_tokens(self):
        assert estimate_cost("openrouter/openai/o1", 0, 0) == 0.0
...
class TestCostTracker:
    def test_record_accumulates(self):
        ...
        tracker.record("openrouter/openai/o1", 1000, 500)
        tracker.record("openrouter/openai/o1", 2000, 1000)
    ...
    def test_budget_enforcement(self):
        ...
        tracker.record("openrouter/openai/o1", 1_000_000, 500_000)  # way over budget
        with pytest.raises(BudgetExceededError):
            tracker.check_budget()

    def test_under_budget_no_raise(self):
        tracker = CostTracker(budget_limit=100.0)
        tracker.record("openrouter/openai/o1", 100, 50)
    ...
    def test_history_recorded(self):
        ...
        assert tracker.history[0]["model"] == "openrouter/openai/o1"
