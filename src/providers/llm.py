...
# Implement uses Sonnet 4.5 for code quality — prompted to NOT inject new knowledge.
...
DEFAULT_MODEL_MAP: dict[str, str] = {
    ...
    "implement": "openrouter/anthropic/claude-sonnet-4-5-20250514",  # Code quality — prompted not to deviate
}
